...
void getLeastAndGreatestValues(Node *root, int *least, int *greatest);
...
int main() {
    ...
    getLeastAndGreatestValues(bst, &least, &greatest);
...
void getLeastAndGreatestValues(Node *root, int *least, int *greatest) {
    ...
    while(leftSubTree != NULL) {
        *least = leftSubTree->key;
        leftSubTree = leftSubTree->left;
    }
    while(rightSubTree != NULL) {
        *greatest = rightSubTree->key;
